...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Please fill the form below</p>
    ...
    <form action="{{ url('/insertuser') }}" method="post">
      ...
      <div class="form-group">
        ...
        <select class="form-control select2" name="category" style="width: 100%;">
          <option selected="selected" value="0">Basic</option>
    ...
    <br/>
    <center>Already have an account? <a href="{{ url('/signin') }}" class="text-center">Sign in</a></center>
